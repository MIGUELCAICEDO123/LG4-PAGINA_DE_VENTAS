...
<div class="form-group">
    <p class="h2 text-center">CREA TU CUENTA</p>
    <div class="text-center h6">
        ¿Ya tienes cuenta?&nbsp;<a href="iniciar_sesion.php?id=<?= $ide?>&sesion=<?= $Sesion?>&pass=<?= $pass?>">inicia sesion aqui</a>
    </div>
</div>
<div class="border border-dark container bg-info rounded-lg font-weight-bold">
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <select id="Identificador" class="form-control border border-dark" name="identificador">
                    ...
                    <option value="+52">+61 (Australia)</option>
                    <option value="+52">+86 (China)</option>
                    <option value="+52">+1 (Estados Unidos)</option>
                    <option value="+52">+505 (Nicaragua)</option>
                </select>
            </div>
            <div class="col">
